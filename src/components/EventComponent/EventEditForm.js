...
function EventEditForm() {
  const { eventId } = useParams();
    ...
    useEffect(() =>{
      eventFormService.getEventUpdateData(eventId)
      .then(response => {
    ...
    const handleSubmit = (e) => {
      ...
      eventFormService.updateEvent(eventId, formData)
        .then(response => {
    ...
    return (
        <div className="event-form-container">
          <h2>Edit {formData.eventTitle} Event</h2>
